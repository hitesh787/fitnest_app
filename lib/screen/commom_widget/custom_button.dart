...
class CustomButton extends StatelessWidget {
  ...
  final String? title;
  const CustomButton({super.key, required this.onPress, this.title});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
          child: Text(title ?? "",style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: AppColors.whiteColor),)
        ),
      ),
    );
  }
